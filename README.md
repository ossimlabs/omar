...
Online guide can be found at [http://ossimlabs.s3-website-us-east-1.amazonaws.com/omar-docs-master/](http://ossimlabs.s3-website-us-east-1.amazonaws.com/omar-docs-dev/).   This is a temporary location for this is the documentation generated for the dev branch distribution and is updated on any change.  In the future we will have webhosting for versioned docuementation

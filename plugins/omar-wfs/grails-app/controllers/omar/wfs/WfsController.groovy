...
//    println '*' * 40
  ...
  @ApiImplicitParams([
          ...
          @ApiImplicitParam(name = 'outputFormat', value = 'Output format', defaultValue="JSON", allowableValues="[JSON, KML, GML2, GML3, GML32]", paramType = 'query', dataType = 'string', required=false),

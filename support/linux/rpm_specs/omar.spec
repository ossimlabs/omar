...
export DISK_CLEANUP_HOME=$OMAR_DEV_HOME/apps/disk-cleanup
...
pushd $DISK_CLEANUP_HOME
install -d %{buildroot}/opt/ossimlabs/disk-cleanup
install -p -m644 build/libs/disk-cleanup*.jar %{buildroot}/opt/ossimlabs/disk-cleanup/
popd

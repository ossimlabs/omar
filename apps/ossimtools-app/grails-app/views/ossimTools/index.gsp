...
<%-- Common --%>
                 ...
                 <div class="row">
                    <div class="col-md-12">
                        <span id="helpBlock" class="help-block">Enter distance units in meters</span>
                    </div>
                 </div>
...
<%-- HLZ --%>
                <div class="row">
                    <div class="col-md-6">
                        <div class="checkbox">
                            <label>
                                <input id="toggleHLZ" type="checkbox" checked>Show HLZ
                            </label>
                        </div>
                    </div>
                </div>
...
<%-- Viewshed --%>
                <div class="row">
                    <div class="col-md-6">
                        <div class="checkbox">
                            <label>
                                <input id="toggleViewshed" type="checkbox" checked>Show Viewshed
                            </label>
                        </div>
                    </div>
                </div>
...
<%-- Slope --%>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="checkbox">
                            <label>
                                <input id="toggleSlope" type="checkbox" checked>Show Terrain Slope
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="gainFactor" placeholder="0">
                        </div>
                    </div>
                </div>
...
<%-- Hillshade --%>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="checkbox">
                            <label>
                                <input id="toggleHillshade" type="checkbox" checked>Show Hillshade
                            </label>
                        </div>
                    </div>
                </div>
               ...
               <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sunAz" placeholder="0">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="label label-primary" for="sunEl">Sun Elevation:</label>
                            <input type="text" class="form-control" id="sunEl" placeholder="0">
                        </div>
                    </div>
                </div>

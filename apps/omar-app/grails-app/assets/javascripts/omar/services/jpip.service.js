   ...
   function jpipService( $rootScope, $http,  toastr, $timeout)
   {
      ...
      this.getJpipStream = function( $event, file, entry, projCode )
      {
         ...
         if ( jpipAppEnabled )
         {
            ...
            if ( TRACE ) { console.log( 'jpipServiceUrl: ' +  jpipServiceUrl ); }
            ...
            timerId = setInterval( function() {
               ...
               if ( TRACE ) { console.log('secondsEllapsed: ' + secondsEllapsed ); }

               }, 2000);

            if ( TRACE ) { console.log('jpipServie.getJpipStream exited...'); }

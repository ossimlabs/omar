(function ()
{
    ...
    function beNumberService( $rootScope, $http, $timeout )
    {
        ...
        var typeName = placemarkConfig.tableName;
        var sortBy = placemarkConfig.columnName;
        var geomName = placemarkConfig.geomName;
        var maxFeatures = placemarkConfig.maxResults;
